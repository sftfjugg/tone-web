JOB_TYPE_ITEM_DATA = [
    ...
    {'name': 'variable', 'show_name': '变量', 'description': '用例的变量值', 'config_index': 3},
    {'name': 'reboot', 'show_name': '重启', 'description': '是否开启重启功能', 'config_index': 3},
    {'name': 'script', 'show_name': '脚本', 'description': '是否开启脚本功能', 'config_index': 3},

    {'name': 'cleanup', 'show_name': '清理脚本', 'description': '任务结束后，清理测试机', 'config_index': 4},
